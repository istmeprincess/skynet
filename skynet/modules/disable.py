...
from skynet.modules.helper_funcs.misc import is_module_loaded
import skynet.modules.sql.blacklistusers_sql as bsql
...
if is_module_loaded(FILENAME):
    ...
    from skynet.modules.sql import disable_sql as sql
